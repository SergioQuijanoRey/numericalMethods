from RootSolverMethods import BisectionMethod, RegulaFalsiMethod, NewtonRaphsonMethod
...
function = lambda x: x**3 - 4
derivative = lambda x: 3 * x * x
solver = NewtonRaphsonMethod(function, derivative)
value, error = solver.solve(1.5, max_error = 0, max_iterations = 400, verbose = False)
